...
import { SearchIcon, UploadIcon, PlusIcon, MinusIcon, BoltIcon, FilterIcon, XCircleIcon, PlusCircleIcon } from './icons';
...
const ActionPanel: React.FC<ActionPanelProps> = ({
    ...
    const renderTransactionPanel = () => (
        <div className="rounded-xl border border-white/10 bg-blue-950/80 p-4 shadow-2xl shadow-black/40 backdrop-blur-md sm:p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className="relative">
                    ...
                    <div className="relative">
                        <input
                            ...
                            autoComplete="off"
                            className="block w-full rounded-md border-slate-600 bg-slate-800 py-2 px-3 pr-10 text-slate-200 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                        />
                         {productSearch && (
                            <button
                                type="button"
                    ...
                    <>
                        <div>
                            ...
                            <input
                                ...
                                required
                                className="block w-full rounded-md border-slate-600 bg-slate-800 py-2 px-3 text-slate-200 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                                placeholder="Ej: LOTE12345"
                            />
                        </div>
                        <div>
                            <label htmlFor="notes" className="block text-sm font-medium text-slate-300 mb-1">Notas</label>
                            <input
                                id="notes"
                                type="text"
                                value={notes}
                ...
                <button
                    ...
                    className={`w-full flex justify-center rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm transition-opacity disabled:cursor-not-allowed ${
                        activeTab === 'entries' ? 'bg-green-600 hover:bg-green-500 disabled:opacity-50' : 'bg-red-500 hover:bg-red-400 disabled:opacity-50'
                    }`}
                >
     ...
     const renderEntryFiltersPanel = () => (
        <div className="rounded-xl border border-white/10 bg-blue-950/80 p-4 shadow-2xl shadow-black/40 backdrop-blur-md">
            <h2 className="mb-4 flex items-center gap-2 text-lg font-bold text-slate-200">
            ...
            <div className="space-y-4">
                <div>
                    ...
                    <select
                        ...
                        className="block w-full rounded-md border-slate-600 bg-slate-800 py-2 pl-3 pr-10 text-sm font-medium text-slate-300 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500"
                    >
                    ...
                    <div key={value} className="relative flex items-start">
                        <div className="flex h-6 items-center">
                            <input
                                ...
                                className="h-4 w-4 rounded border-slate-500 bg-slate-800 text-indigo-600 focus:ring-indigo-600"
                            />
                        </div>
         ...
         <div className="rounded-xl border border-white/10 bg-blue-950/80 p-4 shadow-2xl shadow-black/40 backdrop-blur-md">
            ...
            />
             <button
                ...
                className="w-full flex justify-center items-center gap-2 rounded-md bg-violet-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-violet-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
    ...
    const renderCatalogActionsPanel = () => (
         <div className="rounded-xl border border-white/10 bg-blue-950/80 p-4 shadow-2xl shadow-black/40 backdrop-blur-md">
    ...
    return (
        <div className="space-y-6">
            <div className="rounded-xl border border-white/10 bg-blue-950/80 p-4 shadow-2xl shadow-black/40 backdrop-blur-md">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full rounded-md border-slate-600 bg-slate-800 py-2 pl-10 pr-10 font-bold text-slate-200 placeholder-slate-400/80 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500"
                    />
                    {searchQuery && (
                        <button
            ...
            {activeTab === 'exits' && (
             ...
             {activeTab === 'catalog' && renderCatalogActionsPanel()}
        </div>
    );
};
